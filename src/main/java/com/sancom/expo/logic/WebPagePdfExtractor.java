...
public class WebPagePdfExtractor {
    ...
    public static void main(String arg[]) {
        WebPagePdfExtractor webPagePdfExtractor = new WebPagePdfExtractor();
            Map<String, Object> extractedMap = webPagePdfExtractor.processRecord("http://blaqueyard.com/conx/resumefred-converted%20(1)%20(1).pdf");
        System.out.println(extractedMap.get("text"));
        System.out.println(extractedMap.get("text").toString());
    }
}
